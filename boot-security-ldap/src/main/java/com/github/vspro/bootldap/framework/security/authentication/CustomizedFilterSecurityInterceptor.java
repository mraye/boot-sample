...
public class CustomizedFilterSecurityInterceptor extends AbstractSecurityInterceptor implements
        Filter {
    private static final String FILTER_APPLIED = "__spring_security_cus_filterSecurityInterceptor_filterApplied";
